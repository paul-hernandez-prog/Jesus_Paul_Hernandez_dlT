...
#include <stdlib.h>
#include <string.h>
#define CLEAR printf("\033[0;0H\033[2J"); //Ojo esto deberia limpiar la pantalla pero solo funciona en ciertos ambientes.
 ...
 */
  ...
  printf("the address of variable i = %d \n", &i );
...
void ex2_dereferencing_pointers()
{
  ...
  */ 
int d; 
int *ptr_a = &d, *ptr_b = &d , *ptr_c = &d;

*ptr_a = 10;
*ptr_b *= 2;
*ptr_c += 5;

printf("ptr1 lives in %p points to %p that contains: %d", &ptr_a, &d, *ptr_c);
